        ...
        {data &&
          data.map((e: DataProps, i) => {
            ...
            return (
              <div
                key={i}
                className="bg-gray flex gap-6 overflow-hidden column item"
              >
                <div className="event">
                  <div className="text-neutral-900 text-sm">{normalDate}</div>
                  <div>
                    <a
                      className="big-font font-bold text-secondary-blue-500 no-underline leading-4"
                      href={e.url}
                      target="_blank"
                    >
                      {" "}
                  ...
                  <div className="datetime text-xs">{e.date_time}</div>
                  <div className="py-2">
                    {e.description_long && <p>{descriptionLong}</p>}
                  </div>
                </div>
              </div>
            )
