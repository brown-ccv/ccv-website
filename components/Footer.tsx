...
export const Footer = () => {
    ...
    return (
      <footer className="flex flex-col justify-start items-start sm:justify-center sm:items-center w-full bg-brown text-university-gray-100">
        ...
        {/* Copyright Section */}
        <div className="flex flex-row items-center justify-between relative h-[30px] px-6 py-4 w-full bg-[#412D22] font-serif text-base text-neutral-400 md:px-24 md:text-lg">
          <div>&copy; Brown University</div>
          <CCVLogo width={30} height={30}/>
        </div>
      </footer>
    );
  };
