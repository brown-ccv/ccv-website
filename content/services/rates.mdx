...
<RatesGrid>
  ...
  <RatesCard title="Standard GPU Priority">
    - **Partition:** gpu
    - **CPU Cores:** 24
    - **Memory:** 192 GB
    - **GPU:** 4 Std.
  ...
  <RatesCard title="High-End GPU Priority">
    - **Partition:** gpu-he
    - **CPU Cores:** 24
    - **Memory:** 256 GB
    - **GPU:** 4 high-end
...
<SectionHeader title="Purchasing a Condo" />
...
<RatesGrid align="left">
  <RatesCard title="Unreplicated">
    - **Location:** Oscar | Campus Files | Stronghold
    - **Storage Allocation:** Up to 10TB
    - **Cost:** $50/TB/year
  </RatesCard>

  <RatesCard title="Replicated">
...
<SectionHeader title="Pooled Storage Allocations" />
