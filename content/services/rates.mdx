...
standard GPUs. 
<CardGroup>
  <StyledCard title="Exploratory" size="md" titleBgColor="bg-gray-200">
    - **Partition:** batch
    - **CPU Cores:** 64
    - **Memory:** 492 GB
    - **GPU:** None
  ...
  <StyledCard title="HPC Priority" size="md" titleBgColor="bg-keppel-500" >
    - **Partition:** batch
    - **CPU Cores:** 208
    - **Memory:** 1500 GB
    - **GPU:** 2 Standard
  ...
  <StyledCard title="HPC Priority+" size="md" titleBgColor="bg-sunglow-400">
    - **Partition:** batch
    - **CPU Cores:** 416
    - **Memory:** 3000 GB
    - **GPU:** 2 Standard
...
<CardGroup>
  ...
  <StyledCard title="Standard GPU Priority" size="md" titleBgColor="bg-keppel-500" >
    - **Partition:** gpu
    - **CPU Cores:** 24
    - **Memory:** 192 GB
    - **GPU:** 4 Standard
  ...
  <StyledCard title="Standard GPU Priority+" size="md" titleBgColor="bg-sunglow-400">
    - **Partition:** gpu
    - **CPU Cores:** 48
    - **Memory:** 384 GB
    - **GPU:** 8 Standard
...
<CardGroup>
  <StyledCard title="High-End GPU" size="md" titleBgColor="bg-sunglow-400">
    - **Partition:** gpu-he
    - **CPU Cores:** 24
    - **Memory:** 256 GB
    - **GPU:** 4 High-End
...
<CardGroup>
  <StyledCard title="Basic" size="md"  titleBgColor="bg-gray-200">
    - **Location:** Oscar, Campus Files, Stronghold
    - **Storage:** 1TB
    - **Cost:** $0/year
  </StyledCard>

  <StyledCard title="Active Grant Allocation" size="md" titleBgColor="bg-keppel-500">
      - **Location:** Oscar, Campus Files, Stronghold
      - **Storage:** 10TB
...
<CardGroup>
  <StyledCard title="Unreplicated" size="md" titleBgColor="bg-sunglow-400">
    - **Location:** Campus Files
    - **Storage:** User-specified
    - **Cost:** $50/TB/year
  </StyledCard>
  
  <StyledCard title="Replicated" size="md" titleBgColor="bg-sunglow-400">
    - **Location:** Oscar, Campus Files, Stronghold
    - **Storage:** User-specified
    - **Cost:** $100/TB/year
  </StyledCard>
...
<Button size="md" href="/about/help#contact-us" external={false}>
  Contact Us
</Button>
