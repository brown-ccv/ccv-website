...
<CardWrapper>
  <CardContainer title="Basic Account">
  ...
  <CardContainer title="HPC Priority">
    - **Partition:** batch
    - **CPU Cores:** 208
    - **Memory:** 1500 GB
    - **GPU:** 2 Std.
  ...
  <CardContainer title="Standard GPU Priority">
    - **Partition:** gpu
    - **CPU Cores:** 24
    - **Memory:** 192 GB
    - **GPU:** 4 Std.
  ...
  <CardContainer title="High-End GPU Priority">
    - **Partition:** gpu-he
    - **CPU Cores:** 24
    - **Memory:** 256 GB
    - **GPU:** 4 high-end
...
<CardWrapper align="left">
  <CardContainer title="Unreplicated">
    - **Location:** Oscar | Campus Files | Stronghold
    - **Storage Allocation:** Up to 10TB
    - **Cost:** $50/TB/year
  </CardContainer>

  <CardContainer title="Replicated">
