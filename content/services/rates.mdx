...
<RatesGrid>
  ...
  <RateCard title="Standard GPU Priority">
    - **Partition:** gpu
    - **CPU Cores:** 24
    - **Memory:** 192 GB
    - **GPU:** 4 Std.
  ...
  <RateCard title="High-End GPU Priority">
    - **Partition:** gpu-he
    - **CPU Cores:** 24
    - **Memory:** 256 GB
    - **GPU:** 4 high-end
...
<RatesGrid align="left">
  <RateCard title="Unreplicated">
    - **Location:** Oscar | Campus Files | Stronghold
    - **Storage Allocation:** Up to 10TB
    - **Cost:** $50/TB/year
  </RateCard>

  <RateCard title="Replicated">
