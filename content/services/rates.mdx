...
<Card>
  <CardHeader>
    <CardTitle>HPC Priority</CardTitle>
  </CardHeader>
  <CardContent>
    - **Partition:** batch
    - **CPU Cores:** 208
...
<Card>
  <CardHeader>
    <CardTitle>Standard GPU Priority</CardTitle>
  </CardHeader>
  <CardContent>
    - **Partition:** gpu
    - **CPU Cores:** 24
...
<Card>
  <CardHeader>
    <CardTitle>High-End GPU Priority</CardTitle>
  </CardHeader>
  <CardContent>
    - **Partition:** gpu-he
    - **CPU Cores:** 24
...
<Card>
  <CardHeader>
    <CardTitle>Unreplicated</CardTitle>
  </CardHeader>
  <CardContent>
    - **Location:** Oscar | Campus Files | Stronghold  
...
<Card>
  <CardHeader>
    <CardTitle>Replicated</CardTitle>
  </CardHeader>
  <CardContent>
