...
<CardGroup>
  <StyledCard title="Basic Account">
...
<StyledCard title="HPC Priority">
  - **Partition:** batch - **CPU Cores:** 208 - **Memory:** 1500 GB - **GPU:** 2
  Std. - **Max Walltime:** 96hr - **Cost:** $0/month - **Quality-of-Service
  (QOS):** Faster start times
</StyledCard>

<StyledCard title="HPC Priority+">
  - **Partition:** batch - **CPU Cores:** 416 - **Memory:** 3000 - **GPU:** 2
  Std. - **Max Walltime:** 48hr - **Cost:** $0/month - **Quality-of-Service
  (QOS):** Faster start times
</StyledCard>

<StyledCard title="Standard GPU Priority">
  - **Partition:** gpu - **CPU Cores:** 24 - **Memory:** 192 GB - **GPU:** 4
  Std. - **Max Walltime:** 96hr - **Cost:** $67/month
</StyledCard>

<StyledCard title="Standard GPU Priority+">
  - **Partition:** gpu - **CPU Cores:** 48 - **Memory:** 384 GB - **GPU:** 8
  Std. - **Max Walltime:** 96hr - **Cost:** $133/month
</StyledCard>

  <StyledCard title="High-End GPU Priority">
    - **Partition:** gpu-he
    - **CPU Cores:** 24
    - **Memory:** 256 GB
    - **GPU:** 4 high-end
...
<CardGroup align="left">
  <StyledCard title="Basic">
    - **Location:** Oscar | Campus Files | Stronghold - **Storage Allocation:**
    1TB - **Cost:** $0/year
  </StyledCard>
</CardGroup>
