...
<ContentSection title="Office Hours & Support">
  ...
  Need more specialized support beyond office hours? Request a consultation with us.
    <ButtonGroup>
        ...
        <ButtonLink href="https://events.brown.edu/ccv/month" variant="primary_filled">
            View Office Hours
        </ButtonLink>
    </ButtonGroup>
</ContentSection>
...
<ContentSection title="Funding Collaborations">
    ...
    **Full Collaborator Funding:** Effort is fully paid by collaborator
    ...
    <ButtonGroup>
        <ButtonLink href="https://docs.google.com/document/d/1anrhAU6iQxAo-KzNKeiDgLd-ZiC3UsuoRAZUKOBRLB4/edit?usp=sharing" variant="primary_filled">
            Facilities Statement
        </ButtonLink>
        <ButtonLink href="https://docs.google.com/document/d/1GFG9NYSh0pAQuI1n4Hba1-jC_-2ySQ6uzXltc_khnig/edit?usp=sharing" variant="primary_filled">
