...
description: We support faculty in the classroom, providing tutorials or granting access to cutting edge technology for teaching with code.
---
...
<ButtonGroup>
  <MDXButton href="https://docs.ccv.brown.edu/oscar/account-types">
    Learn More
  </MDXButton>
...
<MDXButton href="https://colab.google">
  Learn More
</MDXButton>
...
<ButtonGroup>
  <MDXButton href="https://docs.ccv.brown.edu/jupyterhub">
    Documentation
  </MDXButton>
  <MDXButton href="https://docs.google.com/forms/d/e/1FAIpQLSct9rFCxLhPIezHI-RYRyEuSnvHrPZLMuUSFRTriIyd_3TAfA/viewform?usp=sf_link">
    Request a Hub
  </MDXButton>
</ButtonGroup>
</ContentSection>