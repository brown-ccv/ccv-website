...
<ContentSection title="Storage Definitions" id="definitions">
...
<Accordion type="multiple">
    <StorageAccordion title="Campus File Storage Non-replicated / Research Services" id="cfs-nr">
    ...
    <StorageAccordion title="Campus File Storage Replicated / Research Services" id="cfs">
    ...
    <StorageAccordion title="Campus File Storage / Department File Services" id="department-file-services">
    ...
    <StorageAccordion title="Oscar Storage" id="oscar">
    ...
    <StorageAccordion title="Stronghold" id="stronghold">
    ...
    <StorageAccordion title="Hibernate" id="hibernate">
    ...
    <StorageAccordion title="Lab Archives" id="lab-archives">
    ...
    <StorageAccordion title="Brown Digital Repository" id="bdr">
    ...
    <StorageAccordion title="Google Drive" id="google-drive">
