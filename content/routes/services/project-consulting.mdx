...
slug: /services/project-consulting
category: services
---
...
<ContentSection title="Project Cost Estimation" id="project-cost-estimation">
  ...
  \* Effort is measured in full-time equivalent (FTE) cost. We follow Brown University's
       [salary range guidelines](https://hr.brown.edu/working-brown/compensation/salary-ranges)
        to calculate cost.
</ContentSection>
...
<ContentSection title="Contact Us">
  ...
  * **Initial Consultation**: If you’re unsure whether working with CCV is right for your lab, or if you have any other questions, you can
  schedule a consultation with us by sending an email to <CopyableText>support@ccv.brown.edu</CopyableText>.
