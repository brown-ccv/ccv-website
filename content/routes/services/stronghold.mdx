...
<CardGroup>
  ...
  <StyledCard size="lg" iconName="FaWifi" title="Secure Access & Identity">
      ...
      [Brown Wireless](https://it.brown.edu/services/wireless-network-brown) 
      or off campus through the 
      [Brown VPN](https://it.brown.edu/services/virtual-private-network-vpn), 
